...
class RecommentProductModel{
  static const String collectionName = "Recomments";
  ...
  RecommentProductModel({this.image="no image", this.name = "no name", this.price= "no price",required this.reference, this.proInfo = "no info", this.desInfo = "no info"});


   RecommentProductModel.fromMap(Object ? object , {required this.reference}){
  ...
  RecommentProductModel.fromSnapshot(DocumentSnapshot snapshot)
