...
class PopularModel{
  static const String collectionName = "PopularProduct";
  ...
  PopularModel({this.image="no image", this.name = "no name", this.price= "no price",required this.reference, this.proInfo ="no info", this.desInfo = "no info"});


  PopularModel.fromMap(Object ? object , {required this.reference}){
  ...
  PopularModel.fromSnapshot(DocumentSnapshot snapshot)
