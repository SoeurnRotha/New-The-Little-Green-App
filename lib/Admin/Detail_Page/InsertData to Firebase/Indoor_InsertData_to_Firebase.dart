...
class InsertData_Indoor extends StatefulWidget {
  const InsertData_Indoor({Key? key}) : super(key: key);

  @override
  State<InsertData_Indoor> createState() => _InsertData_IndoorState();
}

class _InsertData_IndoorState extends State<InsertData_Indoor> {
  ...
  CollectionReference collectionReference = FirebaseFirestore.instance.collection("Indoor");
  void addData() async{
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Insert Data to Indoor", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold , fontFamily: "f1", color: Colors.black),),
