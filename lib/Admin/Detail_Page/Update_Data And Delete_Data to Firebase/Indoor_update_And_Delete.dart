...
class Indoor_update_data extends StatefulWidget {
  const Indoor_update_data({Key? key}) : super(key: key);

  @override
  State<Indoor_update_data> createState() => _Indoor_update_dataState();
}

class _Indoor_update_dataState extends State<Indoor_update_data> {
  ...
  Future uploadImage(File _image) async{
    ...
    Reference ref =  FirebaseStorage.instance.ref().child('Indoor').child('Indoor $imgId');
  ...
  get _buildAppbar {
    return AppBar(
      title: Text("Update Indoor Product", style: TextStyle(fontFamily: "f1",fontSize: 20,fontWeight: FontWeight.bold,color: Colors.black),),
      centerTitle: true,
  ...
  get _buildBody{
    return StreamBuilder<QuerySnapshot>(
      stream: FirebaseFirestore.instance.collection("Indoor").snapshots(),
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                ElevatedButton(
                                        ...
                                        child: ListView(
                                          ...
                                          children: [
                                            ...
                                            Padding(
                                              ...
                                              child: ElevatedButton(
                                                onPressed: () async{
                                                  ...
                                                  FirebaseFirestore.instance.collection("Indoor").doc(data.id).update({
                                                    'image' : imageURL,
                                            ...
                                            Padding(
                                              ...
                                              child: ElevatedButton(
                                                onPressed: () async{
                                                  FirebaseFirestore.instance.collection("Indoor")
                                                      .doc(data.id)
                                  ...
                                  child: Text("Edit", style: TextStyle(fontWeight: FontWeight.bold,fontFamily: "f2", fontSize: 20),),
                                  style: ElevatedButton.styleFrom(
