...
class Bast_update_data extends StatefulWidget {
  const Bast_update_data({Key? key}) : super(key: key);

  @override
  State<Bast_update_data> createState() => _Bast_update_dataState();
}

class _Bast_update_dataState extends State<Bast_update_data> {
  ...
  Future uploadImage(File _image) async{
    ...
    Reference ref =  FirebaseStorage.instance.ref().child('BastProducts').child('BastProducts $imgId');
  ...
  get _buildAppbar {
    return AppBar(
      title: Text("Update Bast Product" , style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold, fontFamily: "f1", color: Colors.black),),
      centerTitle: true,
  ...
  get _buildBody{
    return StreamBuilder<QuerySnapshot>(
      stream: FirebaseFirestore.instance.collection("BastProducts").snapshots(),
                                ...
                                child: ListView(
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: ElevatedButton(
                                        onPressed: () async{
                                          ...
                                          FirebaseFirestore.instance.collection("BastProducts").doc(data.id).update({
                                            'image' : imageURL,
                                    ...
                                    Padding(
                                      ...
                                      child: ElevatedButton(
                                        onPressed: () async{
                                          FirebaseFirestore.instance.collection("BastProducts")
                                              .doc(data.id)
