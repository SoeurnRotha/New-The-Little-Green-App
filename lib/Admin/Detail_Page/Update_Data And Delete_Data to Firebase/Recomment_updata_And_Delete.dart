...
class Recomment_update_data extends StatefulWidget {
  const Recomment_update_data({Key? key}) : super(key: key);

  @override
  State<Recomment_update_data> createState() => _Recomment_update_dataState();
}

class _Recomment_update_dataState extends State<Recomment_update_data> {
  ...
  Future uploadImage(File _image) async{
    ...
    Reference ref =  FirebaseStorage.instance.ref().child('Recomments').child('Recomments $imgId');
  ...
  get _buildAppbar {
    return AppBar(
      title: Text("Update Recomment product",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,fontFamily: "f1", color: Colors.black),),
      centerTitle: true,
  ...
  get _buildBody{
    return StreamBuilder<QuerySnapshot>(
      stream: FirebaseFirestore.instance.collection("Recomments").snapshots(),
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                ElevatedButton(
                                        ...
                                        child: ListView(
                                          ...
                                          children: [
                                            ...
                                            Padding(
                                              ...
                                              child: ElevatedButton(
                                                onPressed: () async{
                                                  ...
                                                  FirebaseFirestore.instance.collection("Recomments").doc(data.id).update({
                                                    'image' : imageURL,
                                            ...
                                            Padding(
                                              ...
                                              child: ElevatedButton(
                                                onPressed: () async{
                                                  FirebaseFirestore.instance.collection("Recomments")
                                                      .doc(data.id)
                                  ...
                                  child: Text("Edit", style: TextStyle(fontFamily: "f2", fontWeight: FontWeight.bold,fontSize: 20),),
                                  style: ElevatedButton.styleFrom(
