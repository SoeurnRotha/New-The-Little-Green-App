...
class Indoor_view_Mobile extends StatefulWidget {
  const Indoor_view_Mobile({Key? key}) : super(key: key);

  @override
  State<Indoor_view_Mobile> createState() => _Indoor_view_MobileState();
}

class _Indoor_view_MobileState extends State<Indoor_view_Mobile> {
