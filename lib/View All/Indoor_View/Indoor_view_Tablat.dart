...
class Indoor_view_Tablat extends StatefulWidget {
  const Indoor_view_Tablat({Key? key}) : super(key: key);

  @override
  State<Indoor_view_Tablat> createState() => _Indoor_view_TablatState();
}

class _Indoor_view_TablatState extends State<Indoor_view_Tablat> {
