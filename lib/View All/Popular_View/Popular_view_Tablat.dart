...
class Popular_view_Tablat extends StatefulWidget {
  const Popular_view_Tablat({Key? key}) : super(key: key);

  @override
  State<Popular_view_Tablat> createState() => _Popular_view_TablatState();
}

class _Popular_view_TablatState extends State<Popular_view_Tablat> {
