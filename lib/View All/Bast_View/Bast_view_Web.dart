...
class Bast_view_Web extends StatefulWidget {
  const Bast_view_Web({Key? key}) : super(key: key);

  @override
  State<Bast_view_Web> createState() => _Bast_view_WebState();
}

class _Bast_view_WebState extends State<Bast_view_Web> {
