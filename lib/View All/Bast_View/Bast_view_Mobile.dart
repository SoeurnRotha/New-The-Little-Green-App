...
class Bast_view_Mobile extends StatefulWidget {
  const Bast_view_Mobile({Key? key}) : super(key: key);

  @override
  State<Bast_view_Mobile> createState() => _Bast_view_MobileState();
}

class _Bast_view_MobileState extends State<Bast_view_Mobile> {
