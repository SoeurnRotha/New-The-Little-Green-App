...
class Outdoor_view_Tablat extends StatefulWidget {
  const Outdoor_view_Tablat({Key? key}) : super(key: key);

  @override
  State<Outdoor_view_Tablat> createState() => _Outdoor_view_TablatState();
}

class _Outdoor_view_TablatState extends State<Outdoor_view_Tablat> {
