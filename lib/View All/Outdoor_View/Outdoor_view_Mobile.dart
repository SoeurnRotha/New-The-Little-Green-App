...
import 'package:the_little_green_product_e_com/Mobile_App/Admin/Detail_Page/Bast.dart';
import 'package:the_little_green_product_e_com/Mobile_App/Admin/Detail_Page/Indoor.dart';
import 'package:the_little_green_product_e_com/Mobile_App/Admin/Detail_Page/Outdoor.dart';
...
import 'package:the_little_green_product_e_com/Mobile_App/helper/outdoor_product_helper.dart';
...
import 'package:the_little_green_product_e_com/Mobile_App/model/outdoor_product_model.dart';
...
class Outdoor_view_Mobile extends StatefulWidget {
  const Outdoor_view_Mobile({Key? key}) : super(key: key);

  @override
  State<Outdoor_view_Mobile> createState() => _Outdoor_view_MobileState();
}

class _Outdoor_view_MobileState extends State<Outdoor_view_Mobile> {
  ...
  get _buildAppbar{
    return AppBar(
      ...
      centerTitle: true,
      title: Text("Outdoor View all",style: TextStyle(fontSize: 20,fontFamily: "f2",fontWeight: FontWeight.bold,color: Colors.black),),
  ...
  Widget _getDataFromFirebase(List<DocumentSnapshot> doc){
    List<OutdoorModel> outdoor = doc.map((data) =>
        OutdoorModel.fromSnapshot(data)).toList();
