...
class Outdoor_view_Web extends StatefulWidget {
  const Outdoor_view_Web({Key? key}) : super(key: key);

  @override
  State<Outdoor_view_Web> createState() => _Outdoor_view_WebState();
}

class _Outdoor_view_WebState extends State<Outdoor_view_Web> {
