...
class Slider_update_data extends StatefulWidget {
  const Slider_update_data({Key? key}) : super(key: key);

  @override
  State<Slider_update_data> createState() => _Slider_update_dataState();
}

class _Slider_update_dataState extends State<Slider_update_data> {
  ...
  Future uploadImage(File _image) async{
    ...
    Reference ref =  FirebaseStorage.instance.ref().child('Slider').child('Slider $imgId');
  ...
  get _buildAppbar {
    return AppBar(
      ...
      title: Text("Update Data to Slider", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold , fontFamily: "f1", color: Colors.black),),
                            ...
                            Padding(
                              ...
                              child: ElevatedButton(
                                onPressed: () async{
                                  ...
                                  FirebaseFirestore.instance.collection("Slider").doc(data.id).update({
                                    'image' : imageURL,
