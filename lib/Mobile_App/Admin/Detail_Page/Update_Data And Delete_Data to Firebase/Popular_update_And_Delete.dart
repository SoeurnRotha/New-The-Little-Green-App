...
class Popular_update_data extends StatefulWidget {
  const Popular_update_data({Key? key}) : super(key: key);

  @override
  State<Popular_update_data> createState() => _Popular_update_dataState();
}

class _Popular_update_dataState extends State<Popular_update_data> {
  ...
  Future uploadImage(File _image) async{
    ...
    Reference ref =  FirebaseStorage.instance.ref().child('PopularProduct').child('PopularProduct $imgId');
  ...
  get _buildAppbar {
    return AppBar(
      title: Text("Update Popular Product",style: TextStyle(fontFamily: "f1", fontWeight: FontWeight.bold, fontSize: 20,color: Colors.black),),
      centerTitle: true,
  ...
  get _buildBody{
    return StreamBuilder<QuerySnapshot>(
      stream: FirebaseFirestore.instance.collection("PopularProduct").snapshots(),
                                        ...
                                        child: ListView(
                                          ...
                                          children: [
                                            ...
                                            Padding(
                                              ...
                                              child: ElevatedButton(
                                                onPressed: () async{
                                                  ...
                                                  FirebaseFirestore.instance.collection("PopularProduct").doc(data.id).update({
                                                    'image' : imageURL,
                                            ...
                                            Padding(
                                              ...
                                              child: ElevatedButton(
                                                onPressed: () async{
                                                  FirebaseFirestore.instance.collection("PopularProduct")
                                                      .doc(data.id)
