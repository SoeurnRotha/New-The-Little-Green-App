...
class InsertData_Popular extends StatefulWidget {
  const InsertData_Popular({Key? key}) : super(key: key);

  @override
  State<InsertData_Popular> createState() => _InsertData_PopularState();
}

class _InsertData_PopularState extends State<InsertData_Popular> {
  ...
  CollectionReference collectionReference = FirebaseFirestore.instance.collection("PopularProduct");
  void addData() async{
  ...
  Future uploadImage(File _image) async{
    ...
    Reference ref =  FirebaseStorage.instance.ref().child('Popular').child('Popular $imgId');
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Insert Data to Popular", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold , fontFamily: "f1", color: Colors.black),),
