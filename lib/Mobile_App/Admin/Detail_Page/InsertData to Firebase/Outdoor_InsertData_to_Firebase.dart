...
class InsertData_Outdoor extends StatefulWidget {
  const InsertData_Outdoor({Key? key}) : super(key: key);

  @override
  State<InsertData_Outdoor> createState() => _InsertData_OutdoorState();
}

class _InsertData_OutdoorState extends State<InsertData_Outdoor> {
  ...
  CollectionReference collectionReference = FirebaseFirestore.instance.collection("Outdoor");
  void addData() async{
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Insert Data to Outdoor", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold , fontFamily: "f1", color: Colors.black),),
