...
class InsertData_Bast extends StatefulWidget {
  const InsertData_Bast({Key? key}) : super(key: key);

  @override
  State<InsertData_Bast> createState() => _InsertData_BastState();
}

class _InsertData_BastState extends State<InsertData_Bast> {
  ...
  CollectionReference collectionReference = FirebaseFirestore.instance.collection("BastProducts");
  void addData() async{
  ...
  Future uploadImage(File _image) async{
    ...
    Reference ref =  FirebaseStorage.instance.ref().child('Bast').child('Bast product $imgId');
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Insert Data to Bast", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold , fontFamily: "f1", color: Colors.black),),
