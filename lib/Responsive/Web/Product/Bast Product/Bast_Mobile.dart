...
class Bast_Mobile extends StatefulWidget {
  const Bast_Mobile({Key? key}) : super(key: key);

  @override
  State<Bast_Mobile> createState() => _Bast_MobileState();
}

class _Bast_MobileState extends State<Bast_Mobile> {
