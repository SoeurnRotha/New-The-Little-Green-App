...
class Discount_Mobile extends StatefulWidget {
  const Discount_Mobile({Key? key}) : super(key: key);

  @override
  State<Discount_Mobile> createState() => _Discount_MobileState();
}

class _Discount_MobileState extends State<Discount_Mobile> {
  @override
