...
class Discount_Tablat extends StatefulWidget {
  const Discount_Tablat({Key? key}) : super(key: key);

  @override
  State<Discount_Tablat> createState() => _Discount_TablatState();
}

class _Discount_TablatState extends State<Discount_Tablat> {
  @override
