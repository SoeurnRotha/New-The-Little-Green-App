    ...
    return ListView(
      children: [
        ...
        Container(
          height: 100,
          color: Colors.black,
          child: Center(child: Text("© The Little Green. 2022. All Rights Reserved ", style: TextStyle(fontSize: 15,fontFamily: "f2",fontWeight: FontWeight.bold,letterSpacing: 2,color: Colors.white,decoration: TextDecoration.none),maxLines: 1,overflow: TextOverflow.ellipsis  ,)),
        )
