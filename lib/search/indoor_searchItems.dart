...
class Indoor_Search extends StatefulWidget {
  const Indoor_Search({Key? key}) : super(key: key);

  @override
  State<Indoor_Search> createState() => _Indoor_SearchState();
}

class _Indoor_SearchState extends State<Indoor_Search> {
  String searchName = "";
          ...
          child: Center(
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                hintStyle: TextStyle(fontSize: 17,fontWeight: FontWeight.bold,fontFamily: "f1"),
  ...
  Widget _buildSearchData(){
    return StreamBuilder<QuerySnapshot>(
      stream: (searchName !="" && searchName !=null)
          ...
          .snapshots()
          : FirebaseFirestore.instance.collection('Indoor').snapshots(),
