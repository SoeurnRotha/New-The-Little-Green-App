...
class Recomments_Search extends StatefulWidget {
  const Recomments_Search({Key? key}) : super(key: key);

  @override
  State<Recomments_Search> createState() => _Recomments_SearchState();
}

class _Recomments_SearchState extends State<Recomments_Search> {
  String searchName = "";
  @override
  ...
  Widget _buildSearchData(){
    return StreamBuilder<QuerySnapshot>(
      stream: (searchName !="" && searchName !=null)
          ...
          .snapshots()
          : FirebaseFirestore.instance.collection('Recomments').snapshots(),
                ...
                child: Card(
                  child: Container(
                    ...
                    child: GestureDetector(
                      onTap: (){
                        Navigator.push(context, MaterialPageRoute(builder: (context)=> productView(proInfo: data['proInfo'],desInfo: data['desInfo'],imageProduct: data['image'],nameProduct: data['name'],priceProduct: data['price'],)));
                      },
                      child: Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: Row(
