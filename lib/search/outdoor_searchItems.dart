...
class Outdoor_Search extends StatefulWidget {
  const Outdoor_Search({Key? key}) : super(key: key);

  @override
  State<Outdoor_Search> createState() => _Outdoor_SearchState();
}

class _Outdoor_SearchState extends State<Outdoor_Search> {
  String searchName = "";
